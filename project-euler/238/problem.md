...
Note that substring $\\color{blue}025$ starting at position $\\mathbf 3$, has a sum of digits equal to $7$, but there was an earlier substring (starting at position $\\mathbf 1$) with a sum of digits equal to $7$, so $p(7) = 1$, _not_ $3$.
