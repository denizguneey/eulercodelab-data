...
The $n$<sup>th</sup> term of the sequence of triangle numbers is given by, $t\_n = \\frac12n(n+1)$; so the first ten triangle numbers are: $$1, 3, 6, 10, 15, 21, 28, 36, 45, 55, \\dots$$
