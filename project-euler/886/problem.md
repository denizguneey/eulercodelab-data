...
A permutation of $\\{2,3,\\ldots,n\\}$ is a rearrangement of these numbers. A _coprime permutation_ is a rearrangement such that all pairs of adjacent numbers are coprime.
