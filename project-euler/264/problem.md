...
<table><tbody><tr><td>$A(-4, 3)$, $B(5, 0)$, $C(4, -3)$<br>$A(4, 3)$, $B(5, 0)$, $C(-4, -3)$<br>$A(-3, 4)$, $B(5, 0)$, $C(3, -4)$<br><br><br>$A(3, 4)$, $B(5, 0)$, $C(-3, -4)$<br>$A(0, 5)$, $B(5, 0)$, $C(0, -5)$<br>$A(1, 8)$, $B(8, -1)$, $C(-4, -7)$<br><br><br>$A(8, 1)$, $B(1, -8)$, $C(-4, 7)$<br>$A(2, 9)$, $B(9, -2)$, $C(-6, -7)$<br>$A(9, 2)$, $B(2, -9)$, $C(-6, 7)$<br></td><td><img src="./png/001.gif" class="dark_img" alt="0264_TriangleCentres.gif"></td></tr></tbody></table>
