...
Using four carriages, the worst possible arrangements for Simon, which we shall call _maximix arrangements_, are DACB and DBAC; each requiring him five rotations (although, using the most efficient approach, they could be solved using just three rotations). The process he uses for DACB is shown below.

![0336\_maximix.gif](./png/001.gif)
