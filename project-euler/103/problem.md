...
It _seems_ that for a given optimum set, $A = \\{a\_1, a\_2, \\dots, a\_n\\}$, the next optimum set is of the form $B = \\{b, a\_1 + b, a\_2 + b, \\dots, a\_n + b\\}$, where $b$ is the "middle" element on the previous row.
