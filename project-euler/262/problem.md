...
The following equation represents the _continuous_ topography of a mountainous region, giving the **elevationheight above sea level** $h$ at any point $(x, y)$: $$h = \\left(5000 - \\frac{x^2 + y^2 + xy}{200} + \\frac{25(x + y)}2\\right) \\cdot e^{-\\left|\\frac{x^2 + y^2}{1000000} - \\frac{3(x + y)}{2000} + \\frac 7 {10}\\right|}.$$
