...
The sum of all elevisors of $E$ is denoted $\\mathrm{sev}(E)$.  
For example, $\\mathrm{sev}(\\{1, 2, 5, 6\\}) = 1 + 2 = 3$.

Let $S(n)$ be the sum of $\\mathrm{sev}(E)$ for all subsets $E$ of $\\{1, 2, \\dots, n\\}$.  
