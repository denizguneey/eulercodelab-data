...
![0525-rolling-ellipse-1.gif](./png/001.gif)
...
![0525-rolling-ellipse-2.gif](./png/002.gif)

You are given $C(2, 4) \\approx 21.38816906$.

Find $C(1, 4) + C(3, 4)$. Give your answer rounded to $8$ digits behind the decimal point in the form _ab.cdefghij_.
