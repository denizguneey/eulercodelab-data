...
Analogously, we call a quadrilateral $ABCD$ with sides $a$, $b$, $c$ and $d$, inscribed in a circle with radius $r$, a _pythagorean quadrilateral_, if $a^2+b^2+c^2+d^2=8\\, r^2$.  
...
![PythagoreanQ\_1](./png/001.png)

  

![PythagoreanQ\_2](./png/002.png)
